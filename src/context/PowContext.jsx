...
// POW week numbering (#695) lives in a pure module so the server can use it too;
// re-exported here for existing callers.
import { weekForMs, resolveCurrentWeek } from '../utils/powWeek.js';

export { weekForMs, resolveCurrentWeek };
