...
import { buildBriefPayload } from '../../utils/briefPayload.js';

// Autopilot Phase 4 — the builder lives in a pure module so the server cron can
// share it; re-exported here so existing imports/tests keep working.
export { buildBriefPayload };
