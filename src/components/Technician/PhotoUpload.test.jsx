 ...
 *       from the Cloudinary secure_url of the removed photo.
...
// Two sample Cloudinary secure_url values (the exact format returned by the API).
const URL_A = 'https://res.cloudinary.com/mycloud/image/upload/v1234567890/repair-photos/sess-1/1-1700000000000.jpg';
const URL_B = 'https://res.cloudinary.com/mycloud/image/upload/v1234567890/repair-photos/sess-1/2-1700000000001.jpg';

// Expected public_id extracted from URL_A:
//   split on '/upload/' → 'v1234567890/repair-photos/sess-1/1-1700000000000.jpg'
//   strip extension    → 'v1234567890/repair-photos/sess-1/1-1700000000000'
//   strip version      → 'repair-photos/sess-1/1-1700000000000'
const EXPECTED_PUBLIC_ID_A = 'repair-photos/sess-1/1-1700000000000';
